fn main() {
    ...
    println!();
    println!("{} is aimed at developing competent, creative,innovative, enterpreneurial and ethically-minded persons,capable nof creating value in the diverse fields of computer science. ",w3); 
